...
@endsection
@section('content')
<form action="/ajuan/izin" method="GET" id="frmdataizin">
    <div class="container" style="margin-top: 70px">
        <div class="row">
            <div class="col-8">
                <div class="form-group">
                    <select name="bulan" id="bulan" class="form-control selectmaterialize" required>
            ...
            <div class="col-4">
                <div class="form-group">
                    <select name="tahun" id="tahun" class="form-control selectmaterialize" required>
        ...
        <div class="card mb-1 shadow" >
            <div class="card-body">
                <div class="historicontent">
                    <div class="iconpresensi text-center mb-3 card_izin" kode_izin="{{$d->kode_izin}}" status_approved="{{$d->status_approved}}" data-toggle="modal" data-target="#actionSheetIconed">
                        @if($d->status == "i")
                    ...
                    <div class="datapresensi" style="margin-left: 30px">
                        <div class="in">
