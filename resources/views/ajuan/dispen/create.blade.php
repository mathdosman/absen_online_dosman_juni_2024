...
<!-- app header -->
<div class="appHeader text-light bg-success">
    <div class="left">
        <a href="javascript::" class="headerButton goBack">
        <ion-icon name="chevron-back-outline"></ion-icon>
        </a>
    </div>
    <div class="pageTitle">Form Dispensasi</div>
    <div class="right"></div>
</div>
<!-- appheader -->
@endsection
...
<div class="row" style="margin-top: 4rem">
    <div class="col">
        <form method="POST" action="/izindispen/store" id="frmIzin" enctype="multipart/form-data">
            @csrf
        ...
        <div class="custom-file-upload border border-dark" id="fileUpload1" style="height: 100px !important">
            ...
            aria-label="cloud upload outline"></ion-icon>
                        <i>Harus upload surat dispensasi yang dikeluarkan oleh sekolah</i>
                    </strong>
                </span>
            </label>
        </div>
        ...
        <div class="form-group">
            <button class="btn btn-block bg-success">Kirim</button>
        </div>
        </form>
    </div>
</div>
