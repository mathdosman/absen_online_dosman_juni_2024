...
<div class="row" style="margin-top: 70px; margin-bottom: 70px">
    <div class="col">
        ...
        <div class="form-group">
            <input type="text" id="tgl_izin_dari" name="tgl_izin_dari" class="form-control datepicker" placeholder="Dari" autocomplete="off" value="{{$dataizin->tgl_izin_dari}}" required>
        </div>
        <div class="form-group">
            <input type="text" id="tgl_izin_sampai" name="tgl_izin_sampai" class="form-control datepicker" placeholder="Sampai" autocomplete="off" value="{{$dataizin->tgl_izin_sampai}}" required>
        </div>
        <div class="form-group">
        ...
        @if($dataizin->doc_sid !== null)
            <div class="row">
                <div class="col-12">
                    ...
                    @endphp
                    <img src="{{url($docsid)}}" alt="" class="img-fluid">
                </div>
            </div>
        @endif
        ...
        <div class="form-group border mt-3">
            <input type="text" id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan" autocomplete="off" value="{{$dataizin->keterangan}}">
        </div>
        <div class="form-group">
