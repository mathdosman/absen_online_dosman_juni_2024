            ...
            <div class="col">
                <div class="card">
                    <div class="container mt-3 ms-2">
                        <div class="row">
                            <div class="col-sm">
                                <a href="/konfigurasi/jamkelas/create" class="btn btn-primary" id="btnjamkerja">
                            ...
                            <div class="col-sm">
                                <a href="/konfigurasi/jamkelas" class="btn btn-secondary">Reset</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tbody class="text-center">
                                            @foreach ($jamkelas as $d)
                                                <tr>
                                                    ...
                                                    <td>{{strtoupper($d->kode_js_kelas)}}</td>
                                                    <td>{{strtoupper($d->nama_lokasi)}}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                          ...
                                                          <div class="dropdown-menu dropdown-menu-end" style="">
                                                            <a href="/konfigurasi/jamkelas/{{$d->kode_js_kelas}}/edit" class="edit dropdown-item">
                                                                ...
                                                                <a href="/konfigurasi/jamkelas/{{$d->kode_js_kelas}}/delete" class="delete-confirm dropdown-item">
